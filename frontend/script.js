    ...
    let $addHeader = $(
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="index.html" class="d-inline-flex link-body-emphasis text-decoration-none">
                ...
                <a href="index.html"><img src="images/Logo.png" width="100" height="60"></a>
                <!--
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li><a href="http://localhost:63342/albanda_cinema/frontend/index.html"
                       class="nav-link px-2 link-light">Home</a></li>
                <li><a href="#" class="nav-link px-2">Features</a></li>
                <li><a href="#" class="nav-link px-2">Pricing</a></li>
                <li><a href="#" class="nav-link px-2">FAQs</a></li>
                <li><a href="https://www.linkedin.com/in/albertfgmz" target="_blank" class="nav-link px-2">About me</a>
                </li>
            </ul>
            ...
            <div class="text-end">
                <a href="login.html"  target="_blank"><button type="button" class="btn btn-light text-dark me-2">Login</button></a>
